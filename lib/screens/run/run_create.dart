...
class RunCreateScreen extends StatefulWidget {

  @override
  _RunCreateScreenState createState() => _RunCreateScreenState();

}

class _RunCreateScreenState extends State<RunCreateScreen> {
  ...
  void _clickCreate() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      RunCreateResult res = await RunApi.runCreate(run);

      if (res.type == RunCreateResultType.SUCCESS_200) {
            ...
            FutureBuilder(
              ...
              builder: (context, AsyncSnapshot<dynamic> snap) {
                ...
                if(snap.hasData) {
                  ...
                  print("routeList: " + routeList.toString());
