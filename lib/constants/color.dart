...
class SunRunColors {
  ...
  static const Color djk_bg_dark = Color.fromRGBO(66, 66, 66, 1.0);
  static const Color djk_bg_darker = Color.fromRGBO(33, 33, 33, 1.0);
  static const Color djk_bg_darker_new = Color.fromRGBO(36, 36, 46, 1.0);
  static const Color djk_accent = Color.fromRGBO(255, 167, 38, 1.0);
  static const Color djk_accent_dark = Color.fromRGBO(255, 152, 0, 1.0);
  static const Color djk_bg_light = Color.fromRGBO(36, 36, 46, 1.0);
  static const Color djk_text = Color.fromRGBO(222, 222, 222, 1.0);
  static const Color djk_heading = Colors.white;
  ...
  static const Color primary = djk_accent;
