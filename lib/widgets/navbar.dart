...
// import 'package:sonnen_rennt/screens/trending.dart';
// import 'package:sonnen_rennt/screens/fashion.dart';
// import 'package:sonnen_rennt/screens/notifications.dart';
// import 'package:sonnen_rennt/screens/search.dart';
// import 'package:sonnen_rennt/screens/cart.dart';
...
class Navbar extends StatefulWidget implements PreferredSizeWidget {
  ...
  Navbar(
      ...
      this.noShadow = false,
      this.bgColor = SunRunColors.white,
                        ...
                        IconButton(
                            icon: Icon(
                                ...
                                color: !widget.transparent
                                    ? (widget.bgColor == SunRunColors.white
                                        ? SunRunColors.text
                                        : SunRunColors.white)
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.camera,
                                color: SunRunColors.text, size: 18.0),
                            SizedBox(width: 8),
                            Text(widget.categoryOne,
                                style: TextStyle(
                                    color: SunRunColors.text, fontSize: 14.0)),
                          ],
                        ),
                      ),
                      SizedBox(width: 30),
